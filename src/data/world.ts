      ...
      fields: [
        {
          ...
          label: 'Human Moment',
          options: [
            { id: 'joy', name: 'Joy', description: 'Open, unguarded, nothing held back.', phrase: 'subject lit with open, unguarded joy' },
            { id: 'wonder', name: 'Wonder', description: 'Eyes wide at something just out of frame.', phrase: 'eyes wide with quiet wonder at something off-frame' },
            { id: 'tenderness', name: 'Tenderness', description: 'A gentle, unhurried closeness.', phrase: 'a moment of unhurried tenderness' },
            { id: 'determination', name: 'Determination', description: 'Jaw set, gaze fixed, mind made up.', phrase: 'jaw set with quiet determination, gaze fixed past the lens' },
            { id: 'longing', name: 'Longing', description: 'Wanting something the frame cannot show.', phrase: 'gaze heavy with longing for something beyond the frame' },
            { id: 'solitude', name: 'Solitude', description: 'Alone, and at ease with it.', phrase: 'wrapped in a comfortable, self-contained solitude' },
            { id: 'defiance', name: 'Defiance', description: 'Chin lifted, refusing to look away.', phrase: 'chin lifted in plain defiance, refusing to look away' },
            { id: 'grief', name: 'Grief', description: 'Held just beneath the surface.', phrase: 'grief held just beneath a composed surface' },
            { id: 'dread', name: 'Dread', description: 'Braced for what is coming.', phrase: 'shoulders braced against a creeping dread' },
            { id: 'release', name: 'Release', description: 'The moment tension finally lets go.', phrase: 'the loosened posture of release, tension just let go' },
          ],
        },
      ],
    },
